...
class WalkerConfigModule:
    ...
    def __init__(self):
        ...
        self.ENV = walker.env(env_name='gym_walker2d', rand_seed=1234,
    ...
    def obs_cost_fn(obs):
        ...
        """
        if isinstance(obs, np.ndarray):
            velocity_cost = -obs[:, 8]  # the qvel for the root-x joint
...
CONFIG_MODULE = WalkerConfigModule
